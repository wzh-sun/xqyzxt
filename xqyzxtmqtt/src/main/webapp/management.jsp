    ...
    <div class="page-content d-flex align-items-stretch">
        ...
        <nav class="side-navbar">
            ...
            <ul class="list-unstyled">
                ...
                <li  class="active"><a href="forms.jsp"> <i class="icon-padnote"></i>用户管理 </a></li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-sm">
                                ...
                                <tr>
                                    ...
                                    <c:if test="${user.stutas == 0}">
                                        <td>普通用户</td>
                                    </c:if>
                                    <c:if test="${user.stutas == 1}">
                                        <td>鸡舍管理员</td>
                                    </c:if>
                                    <c:if test="${user.stutas == 2}">
                                        <td>系统管理员</td>
                                    </c:if>
                                    <td>${user.userphone}</td>
                                    <td>${user.userAdd}</td>
                                    <td>
                                        <a href="${pageContext.request.contextPath}/check?userId=${user.userId}">修改</a>&nbsp;<a href="">删除</a>
                                    </td>
                                </tr>
                                </c:forEach>
                                </tbody>
